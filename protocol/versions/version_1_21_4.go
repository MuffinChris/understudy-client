...
func init() { protocol.Register(v1_21_4()) }

func v1_21_4() *protocol.Version {
	return protocol.NewVersion(protocol.VersionSpec{
		...
		Packets: protocol.PacketIDs{
			...
			SBConfigAcceptCodeOfConduct: -1,
			CBConfigDisconnect:          2,
			CBConfigFinishConfiguration: 3,
			CBConfigKeepAlive:           4,
			CBConfigPing:                5,
			CBConfigSelectKnownPacks:    14,
			CBConfigCodeOfConduct:       -1,
			SBPlayTeleportConfirm:       0,
			SBPlayAttack:                -1,
			SBPlayChatMessage:           7,
			SBPlayClientCommand:         10,
			SBPlayUseEntity:             24,
			SBPlayUseItem:               61,
			SBPlayKeepAlive:             26,
			SBPlayPosition:              28,
			SBPlayPositionLook:          29,
			SBPlayLook:                  30,
			SBPlayBlockDig:              39,
			SBPlayHeldItemSlot:          51,
			SBPlayArmAnimation:          58,
			SBPlayBlockPlace:            60,
			SBPlayWindowClick:           16,
			SBPlayCloseWindow:           17,
			SBPlaySelectTrade:           49,
			SBPlayCraftRecipeRequest:    37,
			SBPlayContainerButton:       15,
			SBPlayNameItem:              46,
			SBPlaySetBeaconEffect:       50,
			SBPlaySetCreativeSlot:       54,
			SBPlayPlayerInput:           41,
			SBPlayEntityAction:          40,
			SBPlayChunkBatchReceived:    9,
			SBPlayPlayerLoaded:          42,
			CBPlaySpawnEntity:           1,
			CBPlayBlockChange:           9,
			CBPlayKickDisconnect:        29,
			CBPlayUnloadChunk:           34,
			CBPlayKeepAlive:             39,
			CBPlayMapChunk:              40,
			CBPlayLogin:                 44,
			CBPlayRelEntityMove:         47,
			CBPlayEntityMoveLook:        48,
			CBPlayEntityTeleport:        119,
			CBPlayEntityMotion:          95,
			CBPlayDeathCombatEvent:      62,
			CBPlayPosition:              66,
			CBPlayEntityDestroy:         71,
			CBPlayMultiBlockChange:      78,
			CBPlayRespawn:               76,
			CBPlayUpdateHealth:          98,
			CBPlayGameStateChange:       35,
			CBPlayEntityEffect:          125,
			CBPlayRemoveEntityEffect:    72,
			CBPlayWindowItems:           19,
			CBPlaySetSlot:               21,
			CBPlayOpenWindow:            53,
			CBPlayCloseWindow:           18,
			CBPlayTradeList:             46,
			CBPlayRecipeBookAdd:         68,
		...
		EffectNames:    v1_21_4EffectNames,
...
var v1_21_4Water = [][2]int32{
	{86, 101},
	{13973, 13974},
}

var v1_21_4Lava = [][2]int32{
	{102, 117},
}

var v1_21_4Air = [][2]int32{
	{0, 0},
	{13971, 13972},
}
