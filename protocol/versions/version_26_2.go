...
func init() { protocol.Register(v26_2()) }

func v26_2() *protocol.Version {
	return protocol.NewVersion(protocol.VersionSpec{
		...
		Packets: protocol.PacketIDs{
			...
			SBPlayResourcePack:          49,
			CBPlayResourcePackPush:      81,
			CBPlayResourcePackPop:       80,
			SBHandshake:                 0,
			SBLoginStart:                0,
			SBLoginAcknowledged:         3,
			CBLoginDisconnect:           0,
			CBLoginEncryptionBegin:      1,
			CBLoginSuccess:              2,
			CBLoginCompress:             3,
			SBConfigSettings:            0,
			SBConfigFinishConfiguration: 3,
			SBConfigKeepAlive:           4,
			SBConfigPong:                5,
			SBConfigSelectKnownPacks:    7,
			SBConfigAcceptCodeOfConduct: 9,
			CBConfigDisconnect:          2,
			CBConfigFinishConfiguration: 3,
			CBConfigKeepAlive:           4,
			CBConfigPing:                5,
			CBConfigSelectKnownPacks:    14,
			CBConfigCodeOfConduct:       19,
			SBPlayTeleportConfirm:       0,
			SBPlayAttack:                1,
			SBPlayChatMessage:           9,
			SBPlayClientCommand:         12,
			SBPlayUseEntity:             26,
			SBPlayUseItem:               67,
			SBPlayKeepAlive:             28,
			SBPlayPosition:              30,
			SBPlayPositionLook:          31,
			SBPlayLook:                  32,
			SBPlayBlockDig:              41,
			SBPlayHeldItemSlot:          53,
			SBPlayArmAnimation:          63,
			SBPlayBlockPlace:            66,
			SBPlayWindowClick:           18,
			SBPlayCloseWindow:           19,
			SBPlaySelectTrade:           51,
			SBPlayCraftRecipeRequest:    39,
			SBPlayContainerButton:       17,
			SBPlayNameItem:              48,
			SBPlaySetBeaconEffect:       52,
			SBPlaySetCreativeSlot:       56,
			SBPlayPlayerInput:           43,
			SBPlayEntityAction:          42,
			SBPlayChunkBatchReceived:    11,
			SBPlayPlayerLoaded:          44,
			CBPlaySpawnEntity:           1,
			CBPlayBlockChange:           8,
			CBPlayKickDisconnect:        32,
			CBPlayUnloadChunk:           37,
			CBPlayKeepAlive:             44,
			CBPlayMapChunk:              45,
			CBPlayLogin:                 49,
			...
			CBPlayMultiBlockChange:      84,
			CBPlayRespawn:               82,
			CBPlayUpdateHealth:          104,
			CBPlayGameStateChange:       38,
			CBPlayEntityEffect:          132,
			CBPlayRemoveEntityEffect:    78,
			CBPlayWindowItems:           18,
			CBPlaySetSlot:               20,
			CBPlayOpenWindow:            59,
			CBPlayCloseWindow:           17,
			CBPlayTradeList:             52,
			CBPlayRecipeBookAdd:         74,
			CBPlayHeldItemSlot:          105,
			CBPlayCollect:               124,
			CBPlayChunkBatchStart:       12,
			CBPlayChunkBatchFinished:    11,
		},
		EntityNames:    v26_2EntityNames,
		EffectNames:    v26_2EffectNames,
		ItemNames:      v26_2ItemNames,
		ItemStacks:     v26_2ItemStacks,
		ComponentIDs:   v26_2ComponentIDs,
		SlotDisplayIDs: v26_2SlotDisplayIDs,
		// Confirmed against a 26.2 server, not assumed: twenty items covering
		// every encoding that differs elsewhere replay with no truncated
		// window. Thirty-two component ids moved between 26.1 and 26.2 and not
		// one payload shape did — moving is not the same as changing shape.
		Components: &protocol.ComponentEncoding{},
		Shapes:     v26_2Shapes,
		ShapeRuns:  v26_2ShapeRuns,
		Solid:      v26_2Solid,
		Water:      v26_2Water,
		Lava:       v26_2Lava,
		Air:        v26_2Air,
...
var v26_2Water = [][2]int32{
	{86, 101},
	{15294, 15295},
}

var v26_2Lava = [][2]int32{
	{102, 117},
}

var v26_2Air = [][2]int32{
	{0, 0},
	{15292, 15293},
}
