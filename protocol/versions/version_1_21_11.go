...
func init() { protocol.Register(v1_21_11()) }

func v1_21_11() *protocol.Version {
	return protocol.NewVersion(protocol.VersionSpec{
		...
		Packets: protocol.PacketIDs{
			...
			SBPlayResourcePack:          48,
			CBPlayResourcePackPush:      79,
			CBPlayResourcePackPop:       78,
			SBHandshake:                 0,
			SBLoginStart:                0,
			...
			SBPlayAttack:                -1,
			SBPlayChatMessage:           8,
			SBPlayClientCommand:         11,
			SBPlayUseEntity:             25,
			SBPlayUseItem:               64,
			SBPlayKeepAlive:             27,
			SBPlayPosition:              29,
			SBPlayPositionLook:          30,
			SBPlayLook:                  31,
			SBPlayBlockDig:              40,
			SBPlayHeldItemSlot:          52,
			SBPlayArmAnimation:          60,
			SBPlayBlockPlace:            63,
			SBPlayWindowClick:           17,
			SBPlayCloseWindow:           18,
			SBPlaySelectTrade:           50,
			...
			SBPlayChunkBatchReceived:    10,
			SBPlayPlayerLoaded:          43,
			CBPlaySpawnEntity:           1,
			CBPlayBlockChange:           8,
			...
			CBPlayMapChunk:              44,
			CBPlayLogin:                 48,
			CBPlayRelEntityMove:         51,
			CBPlayEntityMoveLook:        52,
			CBPlayEntityTeleport:        123,
			CBPlayEntityMotion:          99,
			CBPlayDeathCombatEvent:      66,
			CBPlayPosition:              70,
			CBPlayEntityDestroy:         75,
			CBPlayMultiBlockChange:      82,
			CBPlayRespawn:               80,
			CBPlayUpdateHealth:          102,
			CBPlayGameStateChange:       38,
			CBPlayEntityEffect:          130,
			CBPlayRemoveEntityEffect:    76,
		...
		EffectNames:    v1_21_11EffectNames,
...
var v1_21_11EffectNames = []string{
	"minecraft:speed",
	"minecraft:slowness",
	"minecraft:haste",
...
var v1_21_11EntityNames = []string{
...
var v1_21_11Water = [][2]int32{
	{86, 101},
	{15092, 15093},
}

var v1_21_11Lava = [][2]int32{
	{102, 117},
}

var v1_21_11Air = [][2]int32{
	{0, 0},
	{15090, 15091},
}
